...
namespace MvcMovies.Models
{
    public class SampleData : DropCreateDatabaseIfModelChanges<MovieStoreEntities>
    {
        protected override void Seed(MovieStoreEntities context)
        {
            ...
            new List<Movie>
            {
                new Movie { Title = "El silencio de los inocentes", Genre = genres.Single(g => g.Name == "Suspense"), Price = 8.99M, Actor = Actors.Single(a => a.Name == "Jodie Foster"), MovieArtUrl = "/Content/Images/placeholder.gif" },
